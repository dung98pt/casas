...
if __name__ == '__main__':
    ...
    os.system("python evaluate/evaluate_cate2.py --m {} --n {} --w {} --c {}".format(best_model_path, datasetName, winSize, "test"))
    os.system("python evaluate/evaluate_cate2.py --m {} --n {} --w {} --c {}".format(best_model_path, datasetName, winSize, "deploy"))
